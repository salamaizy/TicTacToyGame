package com.example.salaizy.tictactoygame;
...
public class MainActivity extends AppCompatActivity {
    ...
    void CheckWiner(){
        ...
        if( Winer != -1){
            ...
            if(Winer == 1){
                Toast.makeText(this,"Player 1 is winer", Toast.LENGTH_SHORT).show();
            }

            if(Winer == 2){
                Toast.makeText(this,"Player 2 is winer", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    void AutoPlay(){
        ...
        Random r = new Random();
        int RandIndex = r.nextInt(EmptyCells.size()-0)+0; // if size = 3, selecte(0,1,2)
